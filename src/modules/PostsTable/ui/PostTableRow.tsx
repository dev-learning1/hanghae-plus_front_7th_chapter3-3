...
import { TagChip } from "@/features/tag/ui/TagChip.tsx"
import { UserButtonOpenDialog } from "@/features/user/ui/UserButtonOpenDialog.tsx"
...
export function PostTableRow({ post }: { key: Key; post: Post }) {
  ...
  return (
    <TableRow key={post.id}>
      ...
      <TableCell>
        <UserButtonOpenDialog user={post.author} />
      </TableCell>
